...
class DistanceConstraint(Constraint):
    def set_drive_properties(self, stiffness: float, damping: float, enabled: bool = True) -> None: ...
...
class Scene():
    ...
    def create_distance_constraint(self, actor1: ActorBase, pose1: Pose, actor2: ActorBase, pose2: Pose) -> DistanceConstraint: ...
